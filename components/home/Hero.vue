  ...
  <div class="h-full w-full">
    <div class="flex h-full w-full overflow-x-hidden relative">
      <div class="w-full h-full">
        ...
        <div
          class="content w-full md:w-[70vw] lg:w-[50vw] z-20 relative top-1/2 lg:[45%] -translate-y-1/2 left-1/2 sm:pl-2 sm:left-14 md:left-7 lg:left-20 xl:left-24 -translate-x-1/2 sm:-translate-x-0"
        >
